...
def run_trials(agent, env, optuna_trial: trial, trial_name: str) -> float:
    ...
    agent.save("saved_Files/saved_model/a2c")
...
def main() -> None:
    ...
    trial_name = f'saved_Files/{now}_optuna_study_A2C_4_envs.csv'
    ...
    if data is None:
        ...
        agent = A2C('MlpPolicy', env, verbose=1, tensorboard_log="saved_Files/log_dir")
